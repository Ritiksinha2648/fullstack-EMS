    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6 max-w-3xl animate-fade-in">
            ...
            <div className="card p-5 sm:p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                    ...
                    <div>
                        ...
                        <input type="date" name="joinDate" required defaultValue=
                            {initialData?.joinDate ? new Date(initialData.joinDate)
            ...
            <div className="card p-5 sm:p-6">
                ...
                mb-6 pb-4 border-b border-slate-100">Employment Details</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700">
                    ...
                    <div>
                        ...
                        <select name="department" defaultValue={initialData?.department || ""}>
                            ...
                            {DEPARTMENTS.map((deptName) => (
                                <option key={deptName} value={deptName}>{deptName}
                                </option>
                            ))}
                        </select>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="basicSalary" required min="0"
                            step="0.01" defaultValue={initialData?.basicSalary || 0} />
                    ...
                    <div>
                        ...
                        <input type="number" name="allowances"
                            min="0" step="0.01" required defaultValue={initialData?.allowances || 0} />
                    ...
                    <div>
                        ...
                        <input type="number" name="deductions"
                            min="0" step="0.01" required defaultValue={initialData?.deductions || 0} />
                    ...
                    {isEditMode && (
                        ...
                        <div>
                            ...
                            <select name="employmentStatus"
                                required defaultValue={initialData?.employmentStatus} >
