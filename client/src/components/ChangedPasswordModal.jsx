...
const ChangedPasswordModal = ({ open, onClose }) => {
        ...
        <div onClick={onClose}
            ...
            <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md animate-fade-in"
                ...
                <div className="flex items-center justify-between p-6 pb-0">
                    <h2 className="text-lg font-medium text-shadow-slate-900 flex
                    items-center gap-2"> <LockIcon className="w-5 h-5 text-slate-400" />
                        Change Password </h2>
