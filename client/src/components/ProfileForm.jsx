...
const ProfileForm = ({ initialData, onSuccess }) => {
    ...
    return (
        ...
        <form onSubmit={handleSubmit} className="card p-5 sm:p-6 mb-6">
            ...
            pb-4 border-b border-slate-100 flex items-center gap-2">
                <User className="w-5 h-5 text-slate-400" /> Public Profile</h2>
            ...
            <div className="space-y-5">
                ...
                <div>
                    ...
                    <textarea disabled={initialData.isDeleted} name="bio" defaultValue={initialData.bio || ""}
                        placeholder="Write a brief bio..." className={`resize-none ${initialData.isDeleted ?
