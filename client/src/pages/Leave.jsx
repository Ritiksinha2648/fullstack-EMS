  ...
  return (
    <div className="animate-fade-in">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        ...
        {!isAdmin && !isDeleted && (
          <button onClick={() => setShowModel(true)} className="btn-primary flex items-center gap-2 w-full sm:w-auto
          justify-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8">
          {leaveStats.map((s) => (
            ...
            gap-4 relative overflow-hidden group">
              ...
              <div className="absolute left-0 bottom-0 top-0 w-1 rounded-r-full 
              ...
              <div>
                ...
                tracking-tight">{s.value}</p> <span className="text-sm font-normal text-slate-400">Taken</span>
              </div>
