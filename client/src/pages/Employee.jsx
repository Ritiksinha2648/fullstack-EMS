...
try {
  ...
  const url = selectDepartment ? `/employees?department= ${selectDepartment}` : "/employees";
    ...
    <div className="animate-fade-in">
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-5">
          {filtered.length === 0 ? (
            <p className="col-span-full text-center py-16 text-slate-400 bg-white rounded-2xl 
  border border-dashed border-slate-200">No Employee Found</p>
          ) : (
  ...
  items-start justify-center p-4 overflow-y-auto" onClick={() => setShowCreateModel(false)}>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-3xl my-8 animate-fade-in"
            ...
            <div className="flex items-center justify-between p-6 pb-0">
              ...
              <button onClick={() => setShowCreateModel(false)} className="p-2 rounded-lg hover:bg-slate-100 transition-colors
   ...
   bg-black/40 backdrop-blur-sm"  onClick={() => setEditEmployee(null)}>

          <div className="relative bg-white rounded-2xl shadow-2xl
     w-full max-w-3xl my-8 animate-fade-in" onClick={(e) => e.stopPropagation()}>
